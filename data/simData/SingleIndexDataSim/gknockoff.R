# This only include the knockoff filter to computer FDR and Power
# This master R file includes all the R functions for implementing the knockoff filter 
# in high-dimensional linear regression with precision matrix of covariates estimated 
# by the innovated scalable efficient estimation (ISEE) procedure introduced in Fan 
# and Lv (2015).
#
